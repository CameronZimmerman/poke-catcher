...
export default function renderChart(pokeStats, element, chartNum) {

    const canvas = document.createElement('canvas');
    const canvasId = `myChart${chartNum}`;
    canvas.id = canvasId;
    canvas.width = '600';
    canvas.height = '600';
    ...
    var myChart = new Chart(ctx, { // eslint-disable line
        ...
        data: {
            ...
            datasets: [{
                label: `# of seen session #${chartNum}`,
            ...
            {
                label: `# of caught session #${chartNum}`,
