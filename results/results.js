...
var caughtAndSeenChart = new Chart(ctx, { // eslint-disable line
    type: 'bar',
    data: {
...
var speedChart = new Chart(ctx2, { // eslint-disable line
    type: 'bar',
    data: {
        labels: getPropertyArrOfObjArr('name', pokeStats),
        datasets: [{
            label: 'Pokemon Speed',
            data: getPropertyArrOfObjArr('speed', pokeStats),
            backgroundColor: [
                'rgba(255, 99, 132, 0.2)',
                'rgba(255, 99, 132, 0.2)',
                'rgba(255, 99, 132, 0.2)',
...
var typeChart = new Chart(ctx3, { // eslint-disable line
    type: 'radar',
    data: {
        labels: getPropertyArrOfObjArr('type', pokeStats),
        datasets: [{
            label: 'Pokemon caught by type',
            data: getPropertyArrOfObjArr('caught', pokeStats),
            backgroundColor: [
                'rgba(255, 99, 132, 0.2)',
                'rgba(255, 99, 132, 0.2)',
...
var abilityChart = new Chart(ctx4, { // eslint-disable line
    type: 'pie',
    data: {
        labels: getPropertyArrOfObjArr('ability', pokeStats),
        datasets: [{
            label: 'Pokemon caught by ability',
            data: getPropertyArrOfObjArr('caught', pokeStats),
            backgroundColor: [
                'blue',
                'green',
...
var heightAndWeightChart = new Chart(ctx5, { // eslint-disable line
    type: 'horizontalBar',
    data: {
        labels: getPropertyArrOfObjArr('name', pokeStats),
        datasets: [{
            label: 'Height',
            data: getPropertyArrOfObjArr('height', pokeStats),
            backgroundColor: [
                'rgba(255, 99, 132, 0.2)',
                'rgba(255, 99, 132, 0.2)',
                'rgba(255, 99, 132, 0.2)',
        ...
        {
            label: 'Weight',
            data: getPropertyArrOfObjArr('weight', pokeStats),
            backgroundColor: [
                'rgba(54, 162, 235, 0.2)',
                'rgba(54, 162, 235, 0.2)',
                'rgba(54, 162, 235, 0.2)',
